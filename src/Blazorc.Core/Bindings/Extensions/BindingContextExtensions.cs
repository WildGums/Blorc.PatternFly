namespace Blazorc.Bindings
{
    using System;
    using System.Linq.Expressions;
    using Blazorc.Converters;
    using Blazorc.Linq.Expressions;
    ...
    public static class BindingContextExtensions
    {
        ...
        public static CommandBinding AddCommandBinding(this BindingContext bindingContext, object element, string eventName, ICommand command, Binding commandParameterBinding = null)
        {
